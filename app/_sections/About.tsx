...
export default function About() {
    ...
    return (
        <section id="about" ref={ref} className="py-20 px-6 text-gray-900 dark:text-white">
            ...
            >
                Développeur passionné, j&apos;aime concevoir des applications web modernes et interactives. Mon
                objectif est de créer des interfaces élégantes, performantes et accessibles à tous.
            </motion.p>
            <motion.div
                    ...
                    {skills.map((skill) => {
                        ...
                        return (
                            <motion.div
                                key={skill.name}
                                variants={itemVariants}
                                className={`flex flex-col items-center font-bold dark:bg-transparent ${skill.className ||
                                "text-gray-700 dark:text-gray-200"} p-4 rounded-lg shadow-md`}
                            >
